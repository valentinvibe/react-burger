...
export const DEL_ORDER_NUMBER : "DEL_ORDER_NUMBER" = "DEL_ORDER_NUMBER";
export const SORT_INGREDIENTS : "SORT_INGREDIENTS" = "SORT_INGREDIENTS";
export const CLEAR_CHOOSEN_INGREDIENTS : "CLEAR_CHOOSEN_INGREDIENTS" = "CLEAR_CHOOSEN_INGREDIENTS";
...
export const OPEN_PROFILE_MODAL : "OPEN_PROFILE_MODAL" = "OPEN_PROFILE_MODAL";
export const CLOSE_PROFILE_MODAL : "CLOSE_PROFILE_MODAL" = "CLOSE_PROFILE_MODAL";
